...
class Manager(object):
    ...
    def publish_controll(self, topic, msg):
        to_send = [topic, self.identity, pack(msg)]
        print 'publish control', to_send
    ...
    def purge_broker(self):
        ...
        if (time.time() > self.heartbeat_at):
            ...
            for bid, broker in bw:
                self.publish_controll('control.del_broker', {'identity': bid})
    ...
    def on_conf_message(self, sender, msg):
        ...
        if cmd == C_SETUP:
            ...
            if role == 'WORKER':
                ...
                self.publish_controll('control.new_broker', data)
